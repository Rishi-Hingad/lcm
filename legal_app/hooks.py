...
# 	}
    "HearingDetails": {
        ...
        "on_update": "legal_app.legal_app.legal_case_management.doctype.hearing_details.hearing_details.HearingDetails.send_email_notification",
        "validate": "legal_app.legal_app.legal_case_management.doctype.hearing_details.hearing_details.HearingDetails.validate",
    },

    "CaseMaster": {
        "after_insert": "legal_app.legal_app.legal_case_management.doctype.case_master.case_master.CaseMaster.notify_case_creation",
    },
}

calendar_events = {
    "Hearing Details": {
        "get_events": "legal_app.legal_app.legal_case_management.doctype.hearing_details.hearing_details.hearing_details.get_events"
    }
}
...
# 	],
 	"daily": [
        "legal_app.legal_app.legal_case_management.doctype.hearing_details.hearing_details.HearingDetails.send_reminder_emails"
    ],
# 	"hourly": [
